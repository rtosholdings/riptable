...
__all__ = ['DATETIME_TYPES', 'DS_DISPLAY_TYPES', 'GB_FUNCTIONS', 'MATH_OPERATION', 'INVALID_DICT', 'TIMEWINDOW_FUNCTIONS',
           'NumpyCharTypes', 'REDUCE_FUNCTIONS', 'ROLLING_FUNCTIONS', 'SD_TYPES', 'SM_DTYPES',
           'TypeRegister', 'DisplayJustification', 'DisplayColumnColors', 'DisplayArrayTypes', 'DisplayDetectModes',
           'DisplayLength', 'ColHeader',]
...
INVALID_SHORT_NAME="Inv"
INVALID_LONG_NAME="Invalid"
TOTAL_LONG_NAME = "Total"
CLIPPED_LONG_NAME = "Clipped"
FILTERED_LONG_NAME = "Filtered"
# default groupby key name - followed by _n for n # keys
GROUPBY_KEY_PREFIX = "key"

INVALID_POINTER_32 = -2147483648
INVALID_POINTER_U32 = 0xFFFFFFFF          # 4294967295
#INVALID_POINTER_64  = 0x8000000000000000  # -9223372036854775808
INVALID_POINTER_64  = -9223372036854775808
INVALID_POINTER_U64 = 0xFFFFFFFFFFFFFFFF  # 18446744073709551615
...
## TODO
#   np.logical_and: RIPTABLE NP.ALL
#   np.logical_or:  RIPTABLE NP.ANY
}
...
GB_STRING_ALLOWED = [GB_FUNCTIONS.GB_FIRST, GB_FUNCTIONS.GB_NTH, GB_FUNCTIONS.GB_LAST, GB_FUNCTIONS.GB_ROLLING_SHIFT, GB_FUNCTIONS.GB_MODE]
GB_DATE_ALLOWED = [GB_FUNCTIONS.GB_FIRST, GB_FUNCTIONS.GB_NTH, GB_FUNCTIONS.GB_LAST, 
                   GB_FUNCTIONS.GB_MEAN, GB_FUNCTIONS.GB_MIN, GB_FUNCTIONS.GB_MAX, 
                   GB_FUNCTIONS.GB_NANMEAN, GB_FUNCTIONS.GB_NANMIN, GB_FUNCTIONS.GB_NANMAX,
                   GB_FUNCTIONS.GB_MEDIAN, GB_FUNCTIONS.GB_MODE, GB_FUNCTIONS.GB_ROLLING_DIFF,  GB_FUNCTIONS.GB_ROLLING_SHIFT]
...
class TypeRegister:
    ...
    def is_computable(cls, other):
        if not (other.dtype.char in NumpyCharTypes.Noncomputable or
                isinstance(other, cls.Categorical)):
            return True
        return False
    ...
    def is_datelike(cls, arr:np.ndarray):
        ...
        # simple math works, but not larger groupby operations like sum
        result = False
        if isinstance(arr, (TypeRegister.DateTimeNano, TypeRegister.TimeSpan, TypeRegister.Date, TypeRegister.DateSpan)):
            result = True
        return result
