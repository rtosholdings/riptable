...
class FAString(FastArray):
    def __new__(cls, arr, ikey=None, **kwargs):
        ...
        if intype == "S":
            ...
            raise TypeError(
                f"FAString can only be used on byte string and unicode not {arr.dtype!r}"
            )
    ...
    def _apply_func(self, func, funcp, *args, dtype=None, input=None):
        ...
        if input is None:
            ...
            if not isinstance(input, FAString):
                raise TypeError(
                    f"The input= value was not a FAString.  It is {input!r}."
                )
    ...
    def strpbrk(self, str2):
        ...
        if not isinstance(str2, FAString):
            ...
            if len(str2) != 1:
                return TypeError(
                    f"A single string must be passed for str2 not {str2!r}"
                )
            str2 = FAString(str2)
    ...
    def startswith(self, str2):
        ...
        return self._apply_func(
            self.nb_startswith, self.nb_pstartswith, str2, dtype=np.bool
        )
