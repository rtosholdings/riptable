...
from .rt_enum import ColHeader, TypeRegister
                    ...
                    if len(completions) == 0:
                        ...
                        for c in ldir:
                            if not c.startswith("_"):
                                ...
                                completions.append(
                                    Completion(start=startpos + 1, end=dotpos, text=c, type=t, signature="(self)")
                                )
                    ...
                    if isinstance(acobj, TypeRegister.Struct):
                        ...
                        for k in keys:
                            ...
                            movetotop[k] = Completion(
                                start=startpos + 1, end=dotpos, text=k, type=gettype(acobj[k]), signature="(self)"
                            )
