...
from .rt_enum import FILTERED_LONG_NAME, INVALID_DICT, NumpyCharTypes, TypeRegister
from .rt_numpy import hstack, lexsort, mask_andi
...
class GroupByKeys:
    ...
    * Multikey labels are a list of strings of the tuples that will appear when a multikey is displayed. They will also add a filtered tuple
    ...
    def __init__(
        self, grouping_dict, ifirstkey=None, isortrows=None, sort_display=False, pre_sorted=False, prebinned=False
    ):
